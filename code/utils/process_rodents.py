...
rodent_dir = Path("data/Fresno_Rodent_Data")
...
main_rodent_df = pd.concat(frames, ignore_index=True)
...
main_df = pd.read_csv("data/Fresno_Aggregate.csv")
cpy_main = main_df.copy()
